...
後續修正：公告只有月日而缺開始時間時，會沿公告的 Google Forms／支援短網址讀公開報名表，核對表單明列年份、日期與場地後拆出編號場次。「兩場都參加」只算報名組合，不另新增活動。9/20桃園古錐ê講古已補上10:30、11:30兩場及原海報；第一場的結束時間在表單內有11:20／11:30兩種記載，因此僅刊確定的開始時間。這次海報經人工目視核對；持續自動補時來自公開表單，尚未加入通用海報OCR。
