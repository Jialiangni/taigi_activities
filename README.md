...
第一輪先恢復 8 場已核實活動；本輪再逐場核對並新增 50 場，目前正式網站／ICS 共 **58 場：臺北 9、新北 7、桃園 42**。14 場確認免費、10 場收費、34 場費用未公告。共使用 16 個官方活動專頁，OPENTIX 場次另外核對官方 API；詳見[本輪刊登摘要](data/audit/2026-09-18-published-expansion.json)。這不是北北桃全部活動。
