...
class ManualReviewIssueTests(unittest.TestCase):
    def test_only_pending_threads_rows_are_listed_without_commenter_identity(self):
        ...
        audit = {'reviewed_at': '2026-09-19T12:00:00+08:00', 'decisions': [
            {'candidate_id': 'abc', 'source_id': 'threads_review', 'source_url': 'https://threads.com/@example/post/1',
             'title': '故事活動', 'decision': 'pending', 'reason': 'comment_link_authorship_needs_review',
             'review_context': context},
            {'candidate_id': 'def', 'source_id': 'threads_review', 'decision': 'duplicate'},
