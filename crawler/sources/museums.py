...
class MuseumsCrawler:
    ...
    def fetch_activities(self) -> List[Activity]:
        ...
        activities: List[Activity] = [
            ...
            # -----------------------------------------------------------------
            Activity(
                id="shihsanhang_archaeology_taigi_tour",
                ...
                source_platform=SourcePlatformEnum.MUSEUMS,
                source_url="https://tour.ntpc.gov.tw/zh-tw/Attraction/Detail?wnd_id=60&id=110464",
            ...
            Activity(
                ...
                organizer="新北市立黃金博物館",
                source_platform=SourcePlatformEnum.MUSEUMS,
                source_url="https://www.facebook.com/goldmuseum",
                cover_image="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80",
            ...
            Activity(
                ...
                source_platform=SourcePlatformEnum.MUSEUMS,
                source_url="https://tour.ntpc.gov.tw/zh-tw/Attraction/Detail?wnd_id=60&id=110565",
            ...
            Activity(
                ...
                source_platform=SourcePlatformEnum.MUSEUMS,
                source_url="https://tmofa.tycg.gov.tw/ch",
